...
})({"1xPmd":[function(require,module,exports) {
"use strict";
var HMR_HOST = null;
var HMR_PORT = null;
...
function addItemGallery() {
    return _galleryItems.galleryItems.map(({ preview , original , description  })=>{
...
galleryEl.insertAdjacentHTML('beforeend', addItemGallery(_galleryItems.galleryItems));
new _simplelightboxDefault.default('.gallery a', {
    captions: true,
    captionsData: 'alt',
...
},{}],"kaxSc":[function() {},{}]},["1xPmd","6XVkV"], "6XVkV", "parcelRequire4c75")
